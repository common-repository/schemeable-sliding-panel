...
#sliding-panel .tab {
    font-family: <?php sliding_panel_ff('tab'); ?>;
    font-size: <?php sliding_panel_fs('tab'); ?>;
    font-weight: <?php sliding_panel_fw('tab'); ?>;
    font-style: <?php sliding_panel_fst('tab'); ?>;
}


#sliding-panel .tab ul.login {
    color: <?php sliding_panel_c('tab_link_hover'); ?>;
}
...
#sliding-panel .tab ul.login li a {
  color: <?php sliding_panel_c('tab_link'); ?>;
}
