...
class Schemeable_Sliding_Panel_v1_1a_m_Share_Scheme {
  static function setup() {
    $var = new Schemeable_Sliding_Panel_v1_1a_m_Share_Scheme;
  ...
  function add_menu_page_meta_box( $meta_menu_page ) {
      if( $meta_menu_page == 'sliding-panel-options' ) {
        $this->__enqueue_css();
        add_meta_box( 
            'Schemeable_Sliding_Panel_v1_1a_m_Share_Scheme',
  ...
  function get_field_id( $id ) {
    return 'id_Schemeable_Sliding_Panel_v1_1a_m_Share_Scheme_' . $id ;
  }

  function get_field_name( $id ) {
    return 'name_Schemeable_Sliding_Panel_v1_1a_m_Share_Scheme_' . $id ;
  }

  function render_meta_box( $post ) {

    wp_nonce_field( plugin_basename( __FILE__ ), 'Schemeable_Sliding_Panel_v1_1a_m_Share_Scheme_noncename' );
...
<?php 
  ...
  function save_post( $post_id ) {
    ...
    if ( !isset( $_POST['Schemeable_Sliding_Panel_v1_1a_m_Share_Scheme_noncename']) || !wp_verify_nonce( $_POST['Schemeable_Sliding_Panel_v1_1a_m_Share_Scheme_noncename'], plugin_basename( __FILE__ ) ) )
        return;
...
if( is_admin( ) )
  add_action( 'admin_init', array( 'Schemeable_Sliding_Panel_v1_1a_m_Share_Scheme', 'setup' ) );
?>
